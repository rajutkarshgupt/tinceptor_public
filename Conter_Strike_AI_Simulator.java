    ...
    class Environment
{
    ...
    private List<Player> terrorists_array = new LinkedList<Player>();
...
{   
    ...
    public List<Player> fire(List<Player> players_array,int index)
    {
    ...
    public void play()
    {
        ...
        double gx = goal.getX();
        double gy = goal.getY();
        List<Player> opponents_array = new ArrayList<Player>();
        Player p = new Player();
        List<Player> terrorists_array = environment.getTerrorists_array();
    ...
    class Environment
{
    ...
    abstract class Strategy
{
    abstract public ArrayBased.Environment move(ArrayBased.Environment environment,Player p,int player_index,int turn);
}
class Nearest extends Strategy
{
    public ArrayBased.Environment move(ArrayBased.Environment environment,Player p,int player_index,int turn)
    {
        Position p1p = p.getPosition();
            double p1x = p1p.getX();
            double p1y = p1p.getY();
...
class InputHandler {
    ...
    public static void main(String[] args) {
        ...
        String storage_type = sc.next();
        switch(storage_type)
        {
            case "array":
                ArrayBased arraybased = new ArrayBased();
                ArrayBased.Environment array_environment = arraybased.new Environment(total_terrorists,total_counter_terrorists,goal,ter_order,ct_order);
        ...
        arraygameengine.play();
                break;
            case "list":
                ListBased listbased = new ListBased();
                ListBased.Environment list_environment = listbased.new Environment(total_terrorists,total_counter_terrorists,goal,ter_order,ct_order);
                for(int i=0;i<total_terrorists;i++)
        {
            String type = sc.next();
            String strategy = sc.next();
            ...
            switch(type)
            {
                case "aggressive":
                    Aggressive aggressive = new Aggressive( strategy, site, position, orientation, "TERRORISTS", energy_level, speed);
                    list_environment.setTerrorists(aggressive);
                    break;
                case "cautious":
                    Cautious cautious = new Cautious( strategy, site, position, orientation, "TERRORISTS", energy_level, speed);
                    list_environment.setTerrorists(cautious);
                    break;
                case "blind":
                    Blind blind = new Blind( strategy, site, position, orientation, "TERRORISTS", energy_level, speed);
                    list_environment.setTerrorists(blind);
                    break;
            }
        }
        for(int i=0;i<total_counter_terrorists;i++)
        {
            ...
            switch(type)
            {
                case "aggressive":
                    Aggressive aggressive = new Aggressive( strategy, site, position, orientation, "COUNTER-TERRORISTS", energy_level, speed);
                    list_environment.setCounter_terrorists(aggressive);
                    break;
                case "cautious":
                    Cautious cautious = new Cautious( strategy, site, position, orientation, "COUNTER-TERRORISTS", energy_level, speed);
                    list_environment.setCounter_terrorists(cautious);
                    break;
                case "blind":
                    Blind blind = new Blind( strategy, site, position, orientation, "COUNTER-TERRORISTS", energy_level, speed);
                    list_environment.setCounter_terrorists(blind);
                    break;
            }
        }
        ListBased.GameEngine listgameengine;
        listgameengine = listbased.new GameEngine(list_environment);
        listgameengine.play();
                break;
        }
